...
import {
  Search, Plus, X, Check, ArrowLeftRight, ChevronRight, Package, Save
} from 'lucide-react'
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-3">
        <h1 className="text-lg font-semibold text-slate-800 mr-2">Transfers</h1>
        <div className="relative flex-1 min-w-48 max-w-md">
          <Search size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" />
          <input
            ref={searchRef}
            type="text"
            placeholder="Search asset, ID, center, reason…"
            value={search}
